...
def test4a_0():
    ...
    grader.requireIsEqual(0.03, pf.belief.getProb(20, 4))
    grader.requireIsEqual(0.14, pf.belief.getProb(21, 5))
    grader.requireIsEqual(0.83, pf.belief.getProb(22, 6))
...
def test4a_1():
    ...
    grader.requireIsEqual(64, len(pf.particles)) # Most particles lie on the same (row, col) locations

    grader.requireIsEqual(10, pf.particles[(3,9)])
    grader.requireIsEqual(0, pf.particles[(2,10)])
    grader.requireIsEqual(4, pf.particles[(8,4)])
    ...
    pf.elapseTime()
    grader.requireIsEqual(200, sum(pf.particles.values())) # Do not lose particles
    grader.requireIsEqual(63, len(pf.particles)) # Slightly more particles lie on the same (row, col) locations

    grader.requireIsEqual(8, pf.particles[(3,9)])
...
def test4a_2():
    ...
    grader.requireIsEqual(0.055, pf.belief.getProb(20, 4))
    grader.requireIsEqual(0.28, pf.belief.getProb(21, 5))
    grader.requireIsEqual(0.0, pf.belief.getProb(21, 6))
    grader.requireIsEqual(0.665, pf.belief.getProb(22, 6))
    ...
    grader.requireIsEqual(0.44, pf.belief.getProb(21, 6))
    grader.requireIsEqual(0.0, pf.belief.getProb(22, 6))
    grader.requireIsEqual(0.56, pf.belief.getProb(22, 7))
